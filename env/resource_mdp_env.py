...
class ResourceMDPEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.limit_fn = limit_fn if limit_fn is not None else (
            lambda t, sL: self._base_capacity
        )
        ...
        self.reward_profile = reward_profile or {
            i: (1.0, 1.0) for i in range(n_agents)
        }
    ...
    def step(self, actions):
        # Advance SL and recompute capacity
